...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1195: x0 => x0.length,
      _1275: Date.now,
      _1277: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1278: s => {
      ...
      _1280: () => typeof dartUseDateNowForTicks !== "undefined",
      _1281: () => 1000 * performance.now(),
      _1282: () => Date.now(),
      _1285: () => new WeakMap(),
      _1286: (map, o) => map.get(o),
      _1287: (map, o, v) => map.set(o, v),
      _1288: x0 => new WeakRef(x0),
      _1289: x0 => x0.deref(),
      _1295: () => globalThis.WeakRef,
      _1300: s => JSON.stringify(s),
      _1301: s => printToConsole(s),
      _1302: (o, p, r) => o.replaceAll(p, () => r),
      _1304: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1305: s => s.toUpperCase(),
      _1306: s => s.trim(),
      _1307: s => s.trimLeft(),
      _1308: s => s.trimRight(),
      _1309: (string, times) => string.repeat(times),
      _1310: Function.prototype.call.bind(String.prototype.indexOf),
      _1311: (s, p, i) => s.lastIndexOf(p, i),
      _1312: (string, token) => string.split(token),
      _1313: Object.is,
      _1318: a => a.pop(),
      _1319: (a, i) => a.splice(i, 1),
      _1320: (a, s) => a.join(s),
      _1321: (a, s, e) => a.slice(s, e),
      _1324: a => a.length,
      _1326: (a, i) => a[i],
      _1327: (a, i, v) => a[i] = v,
      _1329: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1330: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1331: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1332: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1333: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1334: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1335: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1336: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1338: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1339: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1340: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1341: (t, s) => t.set(s),
      _1343: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1345: o => o.buffer,
      _1346: o => o.byteOffset,
      _1347: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1348: (b, o) => new DataView(b, o),
      _1349: (b, o, l) => new DataView(b, o, l),
      _1350: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1351: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1352: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1353: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1354: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1355: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1356: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1357: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1358: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1359: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1360: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1361: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1364: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1365: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1366: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1367: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1368: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1369: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1386: o => Object.keys(o),
      _1387: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1388: (handle) => clearTimeout(handle),
      _1391: (c) =>
